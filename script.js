    ...
    if (inOptionsMenu) {
        if (currentIndex === 0) {
            screen.innerHTML = `
                ...
                <div>
                    <p style="padding:10px;">This website itself is a reflection of my journey in creating these works: only 3 buttons are working properly, everything is accessed through pop-ups and you constantly have to refresh to try and get something new. Again and again, it's a frustrating rinse and repeat, until finally, you (and I) have finished everything.</p>
                </div>`;
            ...
            screen.innerHTML = `
                <div onclick="openPopup('https://s3942372.github.io/Minimalist_A1/')" style="cursor:pointer">
                    <p style="padding:10px;">Click here to try out my 'Ma' interaction!</p>
                </div>
                <div onclick="openPopup('https://s3942372-minimalist-a4.deno.dev/Ma')" style="cursor:pointer">
                    <p style="padding:10px;">Click here to read my reflection.</p>
                </div>`;
            optionsList.innerHTML = "";
            selectedOptionText.style.display = "none";
            inOptionsMenu = false;
            ...
            screen.innerHTML = `
                <div onclick="openPopup('https://s3942372.github.io/Minimalist_A2_P1/')" style="cursor:pointer">
                    <p style="padding:10px;">Click here to try out my 'Hint Fiction' interaction!</p>
                </div>
                <div onclick="openPopup('https://s3942372.github.io/Minimalist_A2-1/')" style="cursor:pointer">
                    <p style="padding:10px;">Click here to try out my original 'Hint Fiction' interaction!</p>
                </div>
            ...
            screen.innerHTML = `
                <div onclick="openPopup('https://s3942372.github.io/Minimalist_A2-2/')" style="cursor:pointer">
                    <p style="padding:10px;">Click here to try out my 'Oulipo' interaction!</p>
                </div>
            ...
            screen.innerHTML = `
                <div onclick="openPopup('https://scratch.mit.edu/projects/1074609102/embed')" style="cursor:pointer">
                    <p style="padding:10px;">Click here to try out my game: 'My Dress Up Doll'!</p>
                </div>
            ...
            screen.innerHTML = `
                <div onclick="openPopup('https://scratch.mit.edu/projects/1075341974/embed')" style="cursor:pointer">
                    <p style="padding:10px;">Click here to try out my game: 'Drifting Off'!</p>
                </div>
            ...
            screen.innerHTML = `
                <div onclick="openPopup('https://scratch.mit.edu/projects/1075088739/embed')" style="cursor:pointer">
                    <p style="padding:10px;">Click here to try out my game: 'Punchin' Time!'</p>
                </div>
